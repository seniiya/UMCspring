...
public class QStore extends EntityPathBase<Store> {
    ...
    public final umc.spring.study.domain.mapping.QCategory category;
    ...
    public QStore(Class<? extends Store> type, PathMetadata metadata, PathInits inits) {
        ...
        this.category = inits.isInitialized("category") ? new umc.spring.study.domain.mapping.QCategory(forProperty("category"), inits.get("category")) : null;
